...
<div class="container">
    <div class="row">
         <img class="img-fluid" src="images/ent.jpg">
    </div>
	<div class="row">
         <p style="font-size:15px;color:black;font-weight:700;padding:10px;">
		 Here you can find the interesting tips and amazing fact...
		 </p>
    </div>
	<hr>
	<div class="row">
		  <div class="main_sec">
		  <div class="img_sec"> 
		  <img class="img-thumbnail" src="images/tipsf.png">
		  </div>
		  <div class="post_sec">
		  It providse realtime news of the villages.it is also provide the users.<br>
		  views .66 &nbsp; <a href="#" class="fa fa-whatsapp"></a>
		...
		<div class="row">
		  ...
		  <div class="post_sec">
		  It providse realtime news of the villages.it is also provide the users.<br>
		  views . 99 &nbsp; <a href="#" class="fa fa-whatsapp"></a>
		  </div>
		  </div>
		</div>
    <div class="row">
